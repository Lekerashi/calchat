...
- **Tools:** `list_calendars`, `create_event`, `list_events`, `delete_event`. `create_event.people` is an enum `['logan','yuko','shane','misaki']` driving the emoji convention.
